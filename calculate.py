from config import ENV, DEBUG, DEVIATION, CAMERA_DEVIATION_TO_RIGHT, DISERED_OBJECT_LOCATION, CAUTION_LEVEL_X, CAUTION_LEVEL_Y, STANDARD_SPEED, DROP_DISTANCE, STANDARD_DURATION_SONAR_FORWARD, STANDARD_DURATION_SONAR_TURNING

min_deviation = 55 - DEVIATION
max_deviation = 50 + DEVIATION + CAMERA_DEVIATION_TO_RIGHT
